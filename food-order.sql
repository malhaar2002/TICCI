...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3010592003ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=food-order&table=tbl_food">`food-order`.`tbl_food`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=food-order&table=tbl_category">`food-order`.`tbl_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=food-order&table=tbl_user">`food-order`.`tbl_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=food-order&table=testuser_cart">`food-order`.`testuser_cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=food-order&table=tbl_admin">`food-order`.`tbl_admin`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3263314d364236497d3c226f2c63546b">
