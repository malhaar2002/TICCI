...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <a href="#menu" class="book-a-table-btn scrollto d-none d-lg-flex">Login</a>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://malhaar2002.github.io/Personal-Website/">Malhaar Arora</a> and <a href="">Aditya
          Tyagi</a>
      </div>
    </div>
  </footer><!-- End Footer -->
